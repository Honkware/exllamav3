...
class MellumConfig(Config):
    arch_string = "MellumForCausalLM"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        layer_types = self.read_cfg(list, "layer_types", no_default)
        ...
        self.rope_settings_sliding = self.read_rope_settings_default(
            RopeStyle.NEOX,
            config_dict = {
                "rope_parameters": rope_parameters["sliding_attention"],
                "max_position_embeddings": self.max_position_embeddings,
            },
        )
            ...
            self.modules += [
                TransformerBlock(
                    ...
                    attn = Attention(
                        ...
                        rope_settings = config.rope_settings_full if config.swa_pattern[idx] == -1 else config.rope_settings_sliding,
                        sm_scale = None,
