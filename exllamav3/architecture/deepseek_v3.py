...
# DeepSeek-V3 family (DeepSeek-V3/R1, Moonlight, ...): MLA attention on the shared
# mla_attn substrate inside the standard pre-norm TransformerBlock, DeepSeek MoE
# with noaux_tc (sigmoid + bias) grouped routing. Phase 1: full-sequence forward,
# batch 1, no KV cache.
